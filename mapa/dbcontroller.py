...
class Dbcontroller():
    ...
    def obtener_indice_barrio(self,barrio,denuncias_ciudad):
        SectoresBarrio = self.obtener_SectoresBarrio(barrio)
        denuncias_sector = self.obtener_denuncias_sector(SectoresBarrio)
    ...
    def obtener_SectoresBarrio(self, barrio):
        SectoresBarrio = SectoresBarrio.objects.filter(foco = barrio.id_bario)
        return SectoresBarrio
